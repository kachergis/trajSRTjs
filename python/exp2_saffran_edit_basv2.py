...
def main():
    ...
    # -------------PRODUCTION PHASE-------------
    DisplayText('Thanks! You will be done soon. In this phase, you will try to generate all of the action sequences that you learned in the previous phase. You will be told when you finish one (Correct!) and then you should generate a different one. You will also be told when you make a mistake, in which case you should start the sequence anew. Keep trying until we stop the experiment')
    cond = "test"
    
    word_list=["3013","0131","2313","1312","1230","2301"] #all legal 'words'
        ...
        while done==False:
            ...
            if pygame.time.get_ticks() - trial_start < RSI:
                if Word_completed==True:
                    DisplayReward("Sequence Completed!",Font,(0,255,0),((center[0]-50),center[1]))
                if Penalty==True:
